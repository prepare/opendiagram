...
namespace Crainiate.Diagramming.Examples
{
    ...
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        private void LoadModel()
        {
            ...
            const string resourceAsmName = "OpenDiagram.Diagramming.Resource";

            //Add the fields rows
            //Layer
            TableRow row = new TableRow();
            row.Text = "Layer";
            row.Image = new Crainiate.Diagramming.Image("OpenDiagram.Diagramming.Resource.publicfield", resourceAsmName);
            fieldGroup.Rows.Add(row);

            //SuspendEvents
            row = new TableRow();
            row.Text = "SuspendEvents";
            row.Image = new Crainiate.Diagramming.Image("OpenDiagram.Diagramming.Resource.protectedfield", resourceAsmName);
            fieldGroup.Rows.Add(row);
            ...
            row = new TableRow();
            row.Text = "AddPath";
            row.Image = new Crainiate.Diagramming.Image("OpenDiagram.Diagramming.Resource.publicmethod", resourceAsmName);
            methodGroup.Rows.Add(row);

            row = new TableRow();
            row.Image = new Crainiate.Diagramming.Image("OpenDiagram.Diagramming.Resource.protectedmethod", resourceAsmName);
            row.Text = "SetLayer";
            methodGroup.Rows.Add(row);
